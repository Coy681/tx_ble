...
#define PM_DEBUG			0
#define SUSPEND_CODE_US		498	//the code run time for preparation entering and exiting suspend sleep
                                //70-101(while waiting time)
...
_attribute_data_retention_sec_  static unsigned char 	g_pm_pad_filter_en=0x20;
...
void pm_update_status_info(void)
{
	...
	analog_write_reg8(0x7f, (analog_7f | 0x01 | g_pm_pad_filter_en));
}
 ...
 * @return		none.
 */
_attribute_ram_code_sec_optimize_o2_ static void  pm_sleep_start(pm_sleep_mode_e sleep_mode)
{
	audio_power_down();
 ...
 * @return		none.
 */
_attribute_ram_code_sec_optimize_o2_ static inline void pm_switch_ext32kpad_to_int32krc(void)
{
