...
#define HARDWARE_2M_TS_FROM_AC_DELAY         10
...
//rf prepare
#define HARDWARE_TX_PREPARE_TIME_1M                (HARDWARE_1M_TX_PREPARE_DELAY+HARDWARE_1M_EXTRA_PREAMBLE_DELAY + HARDWARE_TX_EXTRA_DELAY_1M)
#define HARDWARE_TX_PREPARE_TIME_2M                (HARDWARE_2M_TX_PREPARE_DELAY+HARDWARE_2M_EXTRA_PREAMBLE_DELAY + HARDWARE_TX_EXTRA_DELAY_2M)
#define HARDWARE_TX_PREPARE_TIME_CODED             (HARDWARE_CODED_TX_PREPARE_DELAY+HARDWARE_CODED_EXTRA_PREAMBLE_DELAY + HARDWARE_TX_EXTRA_DELAY_CODED)
